...
def create_model(activation="relu", nb_hidden=50, layer_num=4):
  model = Sequential([
...
param_grid = dict(nb_hidden=[100, 150, 200])
...
def plot_history_acc(fit):
  # Plot the loss in the history
  axR.plot(fit.history['acc'],label="acuraccy for training")
...
fig.savefig('./image/wb3_dobn_2000.png')
plt.close()
"""
